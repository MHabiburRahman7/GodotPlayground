...
func populate(accepted_messages: Array[MessageInstance]) -> void:
	refresh(accepted_messages)

func refresh(accepted_messages: Array[MessageInstance]) -> void:
	for child in list.get_children():
		child.queue_free()
	var messages: Array[MessageInstance] = accepted_messages.duplicate()
